...
const About = () => {
    return (
        ...
        <div className="hero-content flex-col lg:flex-row">
          ...
          <img src={person} className="w-4/5 h-80 rounded-lg shadow-2xl"/>
          <img src={parts} className=" w-3/5 h-60 rounded-lg shadow-2xl absolute right-14 top-1/2 border-8 border-white"/>
          </div>
          <div className='lg:w-1/2 pt-20 space-y-5'>
            ...
            <button className="btn bg-yellow-500">Get More Info</button>
          </div>
        </div>
      </div>
    );
